...
const bloques = [
  ...
  },
  {
    ...
    color: "#3A7BD5",
    desc: "Prompt engineering para análisis financiero, ecosistema de herramientas IA, asistentes especializados en due diligence, NotebookLM para research de mercado, programación asistida.",
  ...
  },
  {
    ...
    color: "#D4AF4C",
    desc: "n8n para pipelines de monitoreo financiero, Power Platform para apps internas, Copilot Studio para agentes de compliance, IA agéntica en trading y KYC/AML.",
    topics: ["n8n", "Power Apps", "Power Automate", "AI Builder", "Copilot Studio", "IA agéntica"],
  },
  {
    num: "M04",
    ...
    hours: "10h · 5 sesiones",
    color: "#9B59B6",
    desc: "IA aplicada a las líneas de negocio de BTG Pactual: IB, WM, AM, S&T. Ecosistema FinTech, tokenización, protección de datos, gobernanza y gestión del riesgo.",
    topics: ["FinTech", "Tokenización", "DORA", "DAMA-DMBOK", "Compliance IA", "Gestión de riesgo"],
  },
  {
    num: "M05",
    ...
    hours: "8h · 4 sesiones",
    color: "#E85A1F",
    desc: "Proyecto integrador con metodología JTBD: definición del brief, construcción del MVP, refinamiento con datos reales, Demo Day con liderazgo BTG Pactual.",
    topics: ["JTBD", "MVP", "Testing", "Pitch", "Demo Day", "Certificación"],
  },
];
...
const sesiones = [
  ...
  { n: 5, title: "Asistentes IA para finanzas", sub: "Flujos profesionales de análisis y creación", mod: "M02", active: true },
  { n: 6, title: "Gemini, NotebookLM y Microsoft Copilot", sub: "Investigación documental y ecosistema M365", mod: "M02", active: true },
  { n: 7, title: "Cursor, Claude Code y GitHub Copilot", sub: "Programación asistida por IA", mod: "M02", active: false },
  { n: 8, title: "n8n: automatización sin código", sub: "Conectar herramientas y eliminar trabajo manual", mod: "M03", active: false },
  { n: 9, title: "n8n + IA: automatización inteligente", sub: "LLMs integrados a flujos de automatización", mod: "M03", active: false },
  { n: 10, title: "Power Platform: Power Apps + Power Automate", sub: "Aplicaciones low-code y automatización de procesos", mod: "M03", active: false },
  { n: 11, title: "Copilot Studio, AI Builder y Power BI", sub: "Agentes virtuales y analítica con lenguaje natural", mod: "M03", active: false },
  { n: 12, title: "IA agéntica en finanzas", sub: "Agentes autónomos para trading, compliance y experiencia de cliente", mod: "M03", active: false },
  { n: 13, title: "Ecosistema FinTech 2026", sub: "Del open banking a los agentes financieros autónomos", mod: "M03", active: false },
  { n: 14, title: "Tokenización, blockchain y activos digitales", sub: "La infraestructura financiera del futuro", mod: "M04", active: false },
  { n: 15, title: "IA aplicada a líneas de negocio de BTG Pactual", sub: "IB, WM, AM, S&T, operaciones, compliance y tecnología", mod: "M04", active: false },
  { n: 16, title: "IA y protección de datos: riesgos y mitigación", sub: "Usar IA sin comprometer información sensible", mod: "M04", active: false },
  { n: 17, title: "Gobernanza de datos: marcos regulatorios", sub: "DORA, EU AI Act, Habeas Data y normativa SFC", mod: "M04", active: false },
  { n: 18, title: "Gestión del riesgo tecnológico y compliance IA", sub: "Confianza institucional en soluciones de IA", mod: "M04", active: false },
  { n: 19, title: "Definición del proyecto: Jobs To Be Done", sub: "Elegir correctamente el problema antes de construir la solución", mod: "M05", active: false },
  { n: 20, title: "Desarrollo del prototipo: construcción del MVP", sub: "Construcción del MVP con mentoría técnica", mod: "M05", active: false },
  { n: 21, title: "Desarrollo del prototipo: refinamiento y pitch", sub: "Refinamiento, testing y estructura de pitch ejecutivo", mod: "M05", active: false },
  { n: 22, title: "Demo Day: presentación y cierre", sub: "Presentación por equipos y certificación", mod: "M05", active: false },
];
